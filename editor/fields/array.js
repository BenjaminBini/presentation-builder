// editor/fields/array.js
// Array field rendering

window.renderArrayField = function(field, items) {
    return `
...
window.renderColumnField = function(field, column) {
...
window.renderStatsField = function(field, stats) {
    return `
        <div class="form-group full-width">
...
window.renderStepsField = function(field, steps) {
    return `
        <div class="form-group full-width">
            <label>${field.label}</label>
            ${field.hint ? `<small class="field-hint" style="margin-bottom: 10px;">${field.hint}</small>` : ''}
