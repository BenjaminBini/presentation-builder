...
InlineEditor.startTextEdit = function(element) {
...
InlineEditor.endTextEdit = function(save = true) {
...
InlineEditor.handleKeydown = function(event) {
    switch (event.key) {
        case 'Enter':
...
InlineEditor.changeItemIndentation = function(element, delta) {
...
InlineEditor.handlePaste = function(event) {
    event.preventDefault();
...
InlineEditor.handleDocumentClick = function(event) {
    if (!this.currentEditingElement) return;
...
InlineEditor.handleBlur = function() {
