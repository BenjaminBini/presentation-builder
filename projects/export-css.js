// projects/export-css.js
// CSS generation for exported presentations
...
function getExportCSS() {
    return `
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .template-drawio .drawio-svg svg {
            max-width: 100%;
            max-height: 100%;
        }
        ...
        .template-agenda .agenda-title {
            flex: 1;
            font-size: 24px;
            font-weight: 500;
            color: var(--gl-dark);
        }
        .template-agenda .agenda-duration {
            background: var(--gl-gray-200);
            color: var(--gl-gray-700);
            padding: 6px 16px;
            border-radius: 20px;
...
window.getExportCSS = getExportCSS;
