...
export const ICONS = {
  ...
  text: '<svg class="template-icon" viewBox="0 0 24 24"><rect x="3" y="2" width="18" height="20" rx="2" fill="none"/><rect x="6" y="5" width="12" height="2" rx="0.5" fill="currentColor" stroke="none"/><rect x="6" y="9" width="12" height="1.5" rx="0.5" fill="currentColor" stroke="none" opacity="0.6"/><rect x="6" y="12" width="10" height="1.5" rx="0.5" fill="currentColor" stroke="none" opacity="0.6"/><rect x="6" y="15" width="12" height="1.5" rx="0.5" fill="currentColor" stroke="none" opacity="0.6"/><rect x="6" y="18" width="8" height="1.5" rx="0.5" fill="currentColor" stroke="none" opacity="0.6"/></svg>'
};
