...
export const EventTypes = {
  ...
  // UI refresh events (replaces window.* UI function calls)
  UI_REFRESH_REQUESTED: 'ui:refresh:requested',
  SLIDE_LIST_CHANGED: 'ui:slide:list:changed',
  EDITOR_REFRESH_REQUESTED: 'ui:editor:refresh:requested',
  PREVIEW_REFRESH_REQUESTED: 'ui:preview:refresh:requested'
};
