...
// Convenience exports
export const getAllProjects = () => storage.getAll();
export const getProject = (index) => storage.get(index);
export const getProjectByName = (name) => storage.getByName(name);
export const saveProject = (project) => storage.save(project);
export const deleteProject = (index) => storage.delete(index);
export const projectExists = (name) => storage.exists(name);
export const getAllProjectNames = () => storage.getAllNames();
export const clearProjects = () => storage.clear();
