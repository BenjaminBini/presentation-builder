// templates/components/comparison.js
 ...
 */
function renderComparisonTemplate(data, colorStyles) {
 ...
 */
function renderMermaidTemplate(data, colorStyles) {
  return `
 ...
 */
function renderDrawioTemplate(data, colorStyles) {
